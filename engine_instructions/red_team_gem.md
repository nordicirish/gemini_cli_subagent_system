...
- **The 5-Day Event-Risk Rule:** Search corporate schedules, SEC filings, and macroeconomic calendars. If any binary catalyst event (e.g., earnings release, FDA advisory committee meeting or approval deadline, CPI/FOMC macro prints) is scheduled within the next 5 trading days, you MUST issue a hard veto (Fatal Flaw Score >= 8.0) on any Mean-Reversion or Pullback setup to eliminate catastrophic overnight gap exposure.
