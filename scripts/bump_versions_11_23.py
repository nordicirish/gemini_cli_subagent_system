...
def main():
    target_version = "v11.23-UI-Feedback-Cost-Fix"
    legacy_versions = [
        "v11.22-Diagnostics-Cost-Fix",
        "v11.21-JIT-Cache-Config-Fix",
        "v11.20-Token-UI-HTML-Hotfix",
        "v11.19-Orchestrator-Capability-Probing",
