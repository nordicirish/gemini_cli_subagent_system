...
old_version_target = "v10.39-Quick-Prompt-Spacing-Refinement"
new_ver_suffix = "v10.40-Debate-Title-Expansion-Fix"
...
if os.path.exists(html_path):
    ...
    # Look for query strings like v=10.39 and replace them with v=10.40
    updated_html = re.sub(r"\?v=10\.\d+", "?v=10.40", content)
    if updated_html != content:
        with open(html_path, "w", encoding="utf-8") as f:
            f.write(updated_html)
        print(f"Updated index.html asset cache queries to v10.40")
        updated_count += 1
