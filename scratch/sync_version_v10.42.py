...
old_version_target = "v10.41-Volume-NoneType-TypeError-Fix"
new_ver_suffix = "v10.42-Ticker-Validation-UI-Alert-Sync"
...
if os.path.exists(html_path):
    ...
    # Look for query strings like v=10.41 and replace them with v=10.42
    updated_html = re.sub(r"\?v=10\.41", "?v=10.42", content)
    if updated_html != content:
        with open(html_path, "w", encoding="utf-8") as f:
            f.write(updated_html)
        print(f"Updated index.html asset cache queries to v10.42")
        updated_count += 1
