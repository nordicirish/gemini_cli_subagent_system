...
- **Global Parity:** All registry files must be kept on the exact same version string with a descriptive suffix (e.g., `v10.70-Indices-VWAP-and-3Dec-GEX`).
...
---
**Status:** ACTIVE
**Sync_ID:** ANTIGRAVITY-GLOBAL-SYNC-v10.70-Indices-VWAP-and-3Dec-GEX
