...
### 18. Local File Storage Synchronization Mandate (MANDATE_31-LOCAL)
- **Constraint:** All instruction sets, rules, and telemetry must be stored locally in the workspace. Google Drive synchronization is strictly prohibited.
- **Action:** Rely exclusively on the local filesystem (`gem_trading_rules/`, `engine_instructions/`, `context/`) for rule storage and validation. Do NOT execute any remote cloud or Google Drive synchronization scripts.
...
---
**Status:** ACTIVE
**Sync_ID:** ANTIGRAVITY-GLOBAL-SYNC-v10.69-Local-File-Storage-Lock
