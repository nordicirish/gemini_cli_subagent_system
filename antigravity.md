...
### 17. Debate Logging Integrity (ENH_113)
...
- Breaks, bypasses, or suppresses the permanent logging of the full Council Debate in `decision_log.json` for SSoT mutations, rebalancing, or rule updates (ENH_113).
